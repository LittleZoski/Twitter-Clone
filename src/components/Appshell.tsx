...
export default function AppShellPage({ children }: { children: ReactNode }) {
  ...
  const [newHusq, setNewHusq] = useState(false);
          ...
          <div className="nav">
            <nav>
              ...
              <Button
                ...
                radius="xl"
                mb="xl"
                onClick={() => setNewHusq(true)}
              >
                Husq
              </Button>
              <Modal opened={newHusq} onClose={() => setNewHusq(false)}>
                <CreateHusq replyId={undefined} />
              </Modal>
        ...
        <MediaQuery smallerThan="sm" styles={{ display: "none" }}>
          <Aside p="lg" hiddenBreakpoint="sm" width={{ sm: 400, lg: 400 }}>
            ...
            <Card className="happenings" radius="lg">
              ...
              <button className="articles" style={{ paddingBottom: "25px" }}>
              ...
              <button
                className="articles"
                style={{ color: "#00acee", paddingBottom: "25px" }}
              >
                Show More
              </button>
            </Card>
            ...
            <Card className="follow-me" radius="lg">
              <Group>
                <Text weight={500} style={{ paddingBottom: "10px" }}>
                  <h1>Who To Follow</h1>
                </Text>
              </Group>
              ...
              <button className="articles" style={{ paddingBottom: "50px" }}>
                <img
                  ...
                  width="50"
                  height="50"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLYl8qaEZBXQMTa4l7MmIiL0MU8V44c7w0nA&usqp=CAU"
                  alt="angryman"
                />
                TheAverageStudent <GoVerified color="#00acee" />
              </button>
